        ...
        <div class="widget-wrap"><h3 class="widgettitle widget-title">Connect</h3>
          <div class="textwidget">
            <ul class="social-links">
              <li class="social-link"><a href="https://www.facebook.com/madecollaborative"><img src="<?= get_stylesheet_directory_uri() ?>/fbmods/images/facebook.png" class="social-icon no-wireframify"></a></li>
              <li class="social-link"><a href="https://www.instagram.com/madecollaborative/"><img src="<?= get_stylesheet_directory_uri() ?>/fbmods/images/insta.png" class="social-icon no-wireframify"></a></li>
              <li class="social-link"><a href="https://twitter.com/MadeCollab"><img src="<?= get_stylesheet_directory_uri() ?>/fbmods/images/twitter.png" class="social-icon no-wireframify"></a></li>
            </ul> 
          </div>
        </div>
      </section>
